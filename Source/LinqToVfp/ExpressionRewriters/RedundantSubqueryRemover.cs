...
namespace LinqToVfp.ExpressionRewriters {
    ...
    /// </summary>
    internal class RedundantSubqueryRemover : VfpExpressionVisitor {
        ...
        class RedundantSubqueryGatherer : VfpExpressionVisitor {
        ...
        class SubqueryMerger : VfpExpressionVisitor {
